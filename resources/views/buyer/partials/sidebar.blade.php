...
<aside id="buyerMainSidebar" class="buyer-main-sidebar">
    ...
    <nav class="buyer-sidebar-nav">
        ...
        <a href="{{ route('buyer.dashboard') }}" class="
                buyer-sidebar-link
        ...
        <a href="{{ route('buyer.transactions') }}" class="
                buyer-sidebar-link
        ...
        <a href="{{ route('buyer.notifications') }}" class="
                buyer-sidebar-link
            ...
            @if($buyerUnreadNotificationCount > 0)
                    ...
                    <span class="buyer-sidebar-notification-badge" title="{{
                $buyerUnreadNotificationCount
        ...
        <a href="{{ route('featured-businesses') }}" class="
                buyer-sidebar-link
        ...
        <a href="{{ route('buyer.profile-settings') }}" class="
                buyer-sidebar-link
    ...
    <form method="POST" action="{{ route('account.switch', 'seller') }}">

        @csrf


        <button type="submit" class="buyer-sidebar-link">
...
*/
    ...
    .buyer-sidebar-link.active .buyer-sidebar-notification-badge {
        border-color: #0B4B3C;
