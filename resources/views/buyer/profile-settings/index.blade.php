    ...
    <div class="ps-page-header">
        ...
        <div>
            ...
            <p>
                ...
                Manage your personal information, notification
        ...
        <div class="ps-column">
            ...
            <section class="ps-card">
                ...
                <form
                    ...
                    action="{{
                        route(
                            'buyer.profile-settings.personal'
                        )
                    }}"
                >
            ...
            <section class="ps-security-tip">
                ...
                <p>
                    ...
                    <strong>
                        No card details stored in your profile
                    </strong>
        ...
        <div class="ps-column">
            ...
            <section class="ps-card">
                ...
                <form
                    ...
                    action="{{
                        route(
                            'buyer.profile-settings.notifications'
                        )
                    }}"
                >
                    ...
                    @php
                        ...
                        $notificationOptions = [
                            ...
                            [
                                ...
                                'description' =>
                                    'Payments, escrow and transaction activity.',
...
>
    ...
    <div class="ps-modal-dialog">
        ...
        <form
            ...
            action="{{
                route(
                    'buyer.profile-settings.password'
                )
            }}"
        >
...
>
    ...
    <div class="ps-modal-dialog">
        ...
        <form
            ...
            action="{{
                route(
                    'buyer.profile-settings.two-factor.setup'
                )
            }}"
        >
...
>
    ...
    <div class="ps-modal-dialog ps-2fa-dialog">
        ...
        <form
            ...
            action="{{
                route(
                    'buyer.profile-settings.two-factor.confirm'
                )
            }}"
        >
...
>
    ...
    <div class="ps-modal-dialog">
        ...
        <form
            ...
            action="{{
                route(
                    'buyer.profile-settings.two-factor.disable'
                )
            }}"
        >
