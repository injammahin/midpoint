    ...
    */
    ...
    if ($relativeLogoPath !== '') {
        ...
        if (is_file($absoluteLogoPath)) {
            ...
            |--------------------------------------------------------------------------
            |
            | Do not use $message->embed() because some email clients display
            | embedded images as separate attachments.
            |
            */
...
>
    ...
    <div
        ...
        "
    >
        A password reset was requested for your Midpoint account.
    </div>
                                ...
                                <tr>
                                    ...
                                    >
                                        ...
                                        <p
                                            ...
                                            "
                                        >
                                            Midpoint support will never ask
                                            you to send your password or
                                            reset link by email, text
                                            message, or phone.
                                        </p>
