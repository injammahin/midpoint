@php
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | Values supplied by the Mailable still take priority. These defaults
    | prevent the template from failing if an optional display value is absent.
    */
    $type = (string) ($type ?? 'updated');

    $emailTitle = $emailTitle ?? match ($type) {
        'approved' => 'Seller application approved',
        'payment_successful' => 'Seller package activated',
        'revision_required' => 'Seller application revision required',
        default => 'Seller application updated',
    };

    $emailMessage = $emailMessage ?? match ($type) {
        'approved' =>
            'Your application is approved and your invoice is ready.',
        'payment_successful' =>
            'Your payment is confirmed and your seller package is active.',
        'revision_required' =>
            'Please update the requested information in your application.',
        default =>
            'There is a new update on your seller application.',
    };
    ...
    $buttonUrl = $buttonUrl ?? route('verified-sellers');
