        ...
        route(
            ...
            : []
                    ...
                    <form id="register-form" method="POST" action="{{ route('register.store') }}">
                        ...
                        <input id="account-role" type="hidden" name="preferred_role"
                        ...
                        <div class="mp-segment">
                            ...
                            <button type="button" class="account-role-btn
                                           {{
        ...
        : ''
                        ...
                        <div class="mp-field">
                            ...
                            <input id="full_name" type="text" name="full_name" value="{{ old('full_name') }}"
                                placeholder="e.g. Chiamaka Nwosu" autocomplete="name" required>
                        ...
                        <div class="mp-field">
                            ...
                            <input id="phone" type="tel" name="phone" value="{{ old('phone') }}" placeholder="0803 123 4567"
                                autocomplete="tel" inputmode="tel" maxlength="20"
                                aria-describedby="phone-help phone-client-error" required>

                            <p id="phone-help" class="mt-1.5 text-[11px] leading-[1.5] text-[#7A8680]">

                            </p>

                            <p id="phone-client-error" class="mt-1.5 hidden text-[11px] font-semibold text-red-600"
                                role="alert"></p>
                        ...
                        <div class="mp-field">
                            ...
                            <div class="relative">
                                ...
                                <button type="button"
                                    ...
                                    data-target="register_password" aria-label="Show password" aria-pressed="false">
                        ...
                        <div class="mp-field">
                            ...
                            <div class="relative">
                                ...
                                <input id="password_confirmation" type="password" name="password_confirmation"
                                    placeholder="Re-enter your password" minlength="8" autocomplete="new-password"
                                    class="!pr-[48px]" required>
                        ...
                        <p class="mt-[14px]
                            ...
                            <a href="{{ route('terms-and-conditions') }}" class="font-semibold text-[#7A5AF8]">
                                Terms
                            </a>,

                            <a href="{{ route('privacy-policy') }}" class="font-semibold text-[#7A5AF8]">
                                Privacy Policy
                            </a>

                            and

                            <a href="{{ route('escrow-policy') }}" class="font-semibold text-[#7A5AF8]">
                                Escrow Policy
                            </a>.
