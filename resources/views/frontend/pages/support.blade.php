...
@section('content')
    ...
    @php
        ...
        $supportItems = [
            ...
            [
                ...
                'href' => route('escrow-policy') . '#release-triggers',
            ],
        ...
        <section class="mp-section">
            ...
            <div class="mp-wrap !max-w-[860px]">
                ...
                <div class="relative
                    ...
                    <input id="support-search" type="search" placeholder="Search help articles, e.g. 'inspection period'"
                        class="w-full
                                           rounded-[14px]
                                           border-[1.5px]
                                           border-[#E4EAE6]
                ...
                {{-- Topics --}}
                <div id="support-grid" class="grid
                                       grid-cols-1
                                       gap-5
                                       sm:grid-cols-2
                                       lg:grid-cols-3">
                    ...
                    @foreach ($supportItems as $item)
                                ...
                                <a href="{{ $item['href'] }}" aria-label="Open {{ $item['title'] }} help" class="support-card
                                                                                               group
                                                                                               mp-card
                                                                                               relative
                                                                                               block
                                                                                               ...
                                                                                               focus:outline-none
                                                                                               focus:ring-2
                                                                                               focus:ring-[#12B76A]/25" data-search="{{
                        strtolower(
                            $item['title']
                            . ' ' .
                            $item['description']
                ...
                {{-- Nothing found --}}
                <div id="support-empty" class="mt-5
                                       hidden
                                       rounded-[18px]
                                       border
                                       border-dashed
                ...
                <div class="mp-card
                    ...
                    <div class="flex
                        ...
                        @if (
                            ...
                            <button type="button" id="live-chat-button" class="mp-btn
                                                                   mp-btn-primary">
                        ...
                        @else
                            ...
                            <button type="button" disabled class="mp-btn
                                                                   cursor-not-allowed
                                                                   border
                                                                   border-[#D9DFDB]
                                                                   bg-[#EEF1EF]
                        ...
                        <a href="{{ route('contact') }}" class="mp-btn
                                               mp-btn-outline">
                            Email us
                        </a>
    ...
    @if(auth()->check())
        ...
        <div id="liveSupportWidget" class="ls-widget" data-start-url="{{
                route(
                    'support.chat.start'
                )
                                        }}" data-session-base="{{
            ...
            <div id="lsPanel" class="ls-panel">
                ...
                <div class="ls-header">
                    ...
                    <button type="button" id="lsClose" class="ls-close" aria-label="Close chat">
                ...
                {{-- Agent/Queue Status --}}
                <div id="lsStatus" class="ls-status">
                    Connecting...
                </div>
                ...
                {{-- Messages --}}
                <div id="lsMessages" class="ls-messages"></div>



                {{-- Attachments selected --}}
                <div id="lsSelectedFiles" class="ls-selected-files"></div>



                {{-- Composer --}}
                <form id="lsComposer" class="ls-composer">

                    <div class="ls-input-wrap">

                        <textarea id="lsInput" rows="1" maxlength="5000" placeholder="Type your message..."></textarea>


                        <label for="lsFiles" class="ls-attachment-button" title="Attach image, video or document">
                        ...
                        <input id="lsFiles" type="file" multiple hidden accept="
                                                            image/jpeg,
                                                            image/png,
                                                            image/webp,
                                                            video/mp4,
                        ...
                        <button type="submit" id="lsSend" class="ls-send">
                ...
                {{-- Rating --}}
                <div id="lsRating" class="ls-rating" hidden>
                    ...
                    <textarea id="lsReview" rows="3" maxlength="2000"
                        placeholder="Anything you'd like us to know? (optional)"></textarea>


                    <button type="button" id="lsSubmitRating" class="ls-rating-submit">
                        Submit feedback
                    </button>


                    <button type="button" id="lsSkipRating" class="ls-rating-skip">
                        Skip
                    </button>
