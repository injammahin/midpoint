        ...
        <section class="mp-section">
            ...
            <div class="mp-wrap !max-w-[820px]">
                ...
                <p class="mb-2
                    ...
                    Midpoint Technologies Ltd (RC 1839204)
                </p>
                ...
                <p class="legal-text">
                    Midpoint provides a marketplace and escrow-style transaction service.
                    Buyers and sellers can find each other through the platform or use Midpoint to secure transactions
                    arranged elsewhere.
                    We do not own, inspect or warrant any item or service traded through the platform, and we are not a
                    party to the
                    underlying contract between the buyer and seller. Midpoint’s role is to facilitate transactions and
                    securely hold and
                    release payments based on the agreed transaction terms.
                </p>
                ...
                <div class="mt-7 flex
                    ...
                    <a href="{{ route('escrow-policy') }}" class="mp-btn mp-btn-outline">
                        Read the Escrow Policy
                    </a>


                    <a href="{{ route('privacy-policy') }}" class="mp-btn mp-btn-outline">
